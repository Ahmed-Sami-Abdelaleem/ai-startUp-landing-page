  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg text-center mt-5 tracking-tighter max-w-sm mx-auto">
          Our revolutionary AI SEO tools have transformed our clients&apos;
          strategies.
        </p>
        <div className="flex overflow-hidden overflow-y-scroll scrollbar-hide  mt-10 [mask-image:linear-gradient(to_right,transparent,black_20%,transparent)]">
          <motion.div
            initial={{
              translateX: "-50%",
            }}
          ...
          >
            {[...testimonials, ...testimonials].map((testimonial) => (
              <div
                ...
                className="border border-white/15 p-6 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(140,69,255,0.3),black)] max-w-xs flex-none"
              >
